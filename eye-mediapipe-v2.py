...
• Press **R** anytime to recalibrate, **Q** to quit.
...
Notes
-----
* macOS: grant *Terminal* (or your IDE) Camera, Accessibility, and Screen‑Recording permissions.
* The mapping is saved to ~/.gaze_calib_poly.json so you calibrate once per screen.
"""
...
CALIB_PATH     = pathlib.Path.home() / '.gaze_calib_poly.json'
POINT_RADIUS   = 10         # pixels of red calibration dot on preview frame
